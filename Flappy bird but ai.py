...
BIRD_IMGS = [pygame.transform.scale2x(pygame.image.load(os.path.join("flappybirdsprite", "bird1.png")))
             ,pygame.transform.scale2x(pygame.image.load(os.path.join("flappybirdsprite", "bird2.png")))
             ,pygame.transform.scale2x(pygame.image.load(os.path.join("flappybirdsprite", "bird3.png")))]

PIPE_IMGS = pygame.transform.scale2x(pygame.image.load(os.path.join("flappybirdsprite", "pipe.png")))
BASE_IMGS = pygame.transform.scale2x(pygame.image.load(os.path.join("flappybirdsprite", "base.png")))
BG_IMGS = pygame.transform.scale2x(pygame.image.load(os.path.join("flappybirdsprite", "bg.png")))
...
def main(genome, config):
    ...
    while run:
        ...
        for x, bird in enumerate(birds):
            ...
            output = nets[x].activate((bird.y, abs(bird.y - pipes[pipe_ind].hight), abs(bird.y - pipes[pipe_ind].bottom)))
